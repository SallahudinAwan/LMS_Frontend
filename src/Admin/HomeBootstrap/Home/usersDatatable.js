  ...
  return (
    <>
      <Box>
        ...
        <Button sx={{m:2,fontSize:13 }} onClick={() => { props.option("adduser"); }}  variant="contained" startIcon={<PersonAddIcon />}>Add User</Button>
        <Button disabled={removeBtn} sx={{m:2,fontSize:13 }} onClick={removeMultipleuser}  variant="contained" startIcon={<DeleteIcon />}>Remove User</Button>
        </Box>
         <DataTable
            className="table"
            columns={columns}
